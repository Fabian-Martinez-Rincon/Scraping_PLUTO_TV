...
def scrape_canales():
    ...
    for i in range(1, 300):
        ...
        element_to_click = find_element_with_retries(driver, xpath, retries=1)
        if element_to_click:
            try:
    ...
    save_to_json(results, CONFIGURATIONS_BUTTONS['categories_file'], "Resultados")
    driver.quit()
